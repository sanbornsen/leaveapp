...
class Position extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pos_name', 'required'),
			array('pos_parent', 'numerical', 'integerOnly'=>true),
			array('pos_name', 'length', 'max'=>255),
			array('pos_name', 'unique', 'attributeName'=> 'pos_name', 'caseSensitive' => 'false'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('pos_id, pos_name, pos_parent', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pos_parent',$this->pos_parent);
